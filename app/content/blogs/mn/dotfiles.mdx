...
The config lives in `~/.config/nvim/` and is structured for easy maintenance.
...
On macOS, **yabai** handles automatic window tiling while **skhd** provides system-wide hotkeys.
