...
tmux is a key part of my [keyboard-driven workflow](/blog/keyboard_driven). I also use it alongside [Neovim](/blog/neovim) with vim-tmux-navigator for seamless pane navigation. Check out [my dotfiles](/blog/dotfiles) to see my full tmux configuration.
